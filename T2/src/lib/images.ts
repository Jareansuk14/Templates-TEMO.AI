...
export type ReviewImage = SiteImage;
...
export const GAME_CARDS: SiteImage[] = [
  { alt: "game1", src: "/images/game1.webp", width: 1200, height: 801 },
  { alt: "game2", src: "/images/game2.webp", width: 1200, height: 801 },
  { alt: "game3", src: "/images/game3.webp", width: 1200, height: 801 },
  { alt: "game4", src: "/images/game4.webp", width: 1200, height: 801 },
  { alt: "game5", src: "/images/game5.webp", width: 800, height: 500 },
  { alt: "game6", src: "/images/game6.webp", width: 800, height: 500 },
];
...
export const REVIEWS: ReviewImage[] = [
  { src: "/images/review1.webp", alt: "คำอธิบาย", width: 1200, height: 525 },
  { src: "/images/review2.webp", alt: "คำอธิบาย", width: 1200, height: 525 },
  { src: "/images/review3.webp", alt: "คำอธิบาย", width: 1200, height: 525 },
];
...
export const REVIEW_PREVIEW_SIZE = { width: 1200, height: 525 } as const;

export function getPromoPreview(count = 3): PromoImage[] {
  return PROMOS.slice(0, count);
}

export function getReviewPreview(count = 3): ReviewImage[] {
